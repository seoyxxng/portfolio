            ...
            <form  name="find" method="post" action="find2.php">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="name" class="find_name" id="name" required placeholder="이름을 입력하세요">
                    </li>
                    <li>
                        <label for="id" class="hidden">아이디</label>
                        <input type="text" name="id" class="find_id" id="id" required placeholder="아이디를 입력하세요">
                    </li>
                    <li class="hp">
